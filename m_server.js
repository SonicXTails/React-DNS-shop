...
app.post('/orders', (req, res) => {
  ...
  const transporter = nodemailer.createTransport({
    ...
    auth: {
      user: 'isip_m.yu.chistotin@mpt.ru', // ваш email
      pass: 'werawera00', // ваш пароль
    },
  });

  const mailOptions = {
    from: 'isip_m.yu.chistotin@mpt.ru', // ваш email
    to: 'isip_m.yu.chistotin@mpt.ru', // email получателя
