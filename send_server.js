...
app.post('/home', (req, res) => {
  ...
  const transporter = nodemailer.createTransport({
    ...
    auth: {
      user: 'isip_m.yu.chistotin@mpt.ru', // your email
      pass: 'werawera00', // your password
    },
  });

  const mailOptions = {
    from: 'isip_m.yu.chistotin@mpt.ru', // your email
    to: 'isip_m.yu.chistotin@mpt.ru', // recipient's email
